...
public class ESRealMain {
    ...
    public static void main(String[] args) {
        ...
        // Parametros - ES
        Integer muCaso1 = 100; // Tamanho da populacao
        Integer muCaso2 = 50; // Tamanho da populacao
        ...
        ESReal esRealCaso1 = new ESReal(minimo, maximo, nVariaveis, problema, muCaso1, lambda, geracoes, pMutacao);
        ESReal esRealCaso2 = new ESReal(minimo, maximo, nVariaveis, problema, muCaso2, lambda, geracoes, pMutacao);
        ...
        for(int i =0; i<60; i++) {
            ...
            if (vezes.get(vez) %2 == 0) {
                ...
                Individuo melhor = esRealCaso1.executar();
                tempoFinal = System.currentTimeMillis();
                melhoresIndividuos.add(melhor);
                pioresIndividuos.add(esRealCaso1.getPiorIndividuo());
            } else {
                tempoAtual = System.currentTimeMillis();
                Individuo melhor = esRealCaso2.executar();
                tempoFinal = System.currentTimeMillis();
                melhoresIndividuos.add(melhor);
                pioresIndividuos.add(esRealCaso2.getPiorIndividuo());
            }
